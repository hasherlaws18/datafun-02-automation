...
has_local_clients: bool = False

# declare an integer variable 
years_in_operation: int = 8

# declare a floating point variable
average_client_satisfaction: float = 5.7

# declare a list of strings

skills_offered: list = ["Data Analysis", "Business Analyst", "Business Intelligence"]

# declare a list of numbers so we can illustrate statistics skills

client_satisfaction_scores: list = [4.8, 4.6, 4.9, 5.0, 5.7, 6.0]
...
byline: str = f"""
---------------------------------------------------------
Houston Analytics: Delivering Professional Insights
---------------------------------------------------------
Has International Clients:  {has_international_clients}
Has Local Clients:          {has_local_clients}
